...
(
    ...
    CONSTRAINT FK_CLUB_ON_ADMIN FOREIGN KEY (admin_id) REFERENCES app."user" (id)
);
...
(
    ...
    CONSTRAINT FK_TICKET_OFFER_ON_USER FOREIGN KEY (posted_by) REFERENCES app."user" (id),
    CONSTRAINT FK_TICKET_OFFER_ON_CLUB FOREIGN KEY (club_id) REFERENCES app."club" (id)
);
...
(
    ...
    CONSTRAINT FK_SEASON_PASS_OFFER_ON_USER FOREIGN KEY (posted_by) REFERENCES app."user" (id),
    CONSTRAINT FK_SEASON_PASS_OFFER_ON_CLUB FOREIGN KEY (club_id) REFERENCES app."club" (id)
);
...
alter table app.season_pass_offer
...
alter table app.club
    add admin_id integer
        constraint club_user_id_fk
            references app."user";
alter table app.club
